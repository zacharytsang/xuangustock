...
def get_total_raw_data(line,i):
    ...
    try:
        ...
        vol_5,per_5 = get_percent_eq(total_data,5,0)
        vol_10,per_10 = get_percent_eq(total_data,8,0)
        #vol_15,per_15 = get_percent_eq(total_data,9,0)
        #y交易日前三线的状态
        y=2
        vol_5_2,per_5_2 = get_percent_eq(total_data,5,y)
        vol_10_2,per_10_2 = get_percent_eq(total_data,8,y)
        y=y+2
        vol_5_3,per_5_3 = get_percent_eq(total_data,5,y)
        vol_10_3,per_10_3 = get_percent_eq(total_data,8,y)
    ...
    print "vol_5_3,per_5_3", vol_5_3,per_5_3,line
    print "vol_10_3,per_10_3", vol_10_3,per_10_3,line
    ...
    if vol_5>vol_10 and vol_5_2>vol_10_2 and vol_5_3>vol_10_3  and vol_5>vol_5_2  and vol_5_2>vol_5_3  and 0.03<per_5 and per_5<0.1:
        lock.acquire()
