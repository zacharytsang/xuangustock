...
def get_percent_eq(date,num,ch):
    ...
    return eq/num,price_up_down/num,count
...
def get_total_raw_data(line,i):
	...
	# print "---------------",ss[0]
        ...
        total_eq_price = []
        total_eq_volume = []
        print type(total_eq_price),type(total_eq_volume),"======",line
	while y<=15:
		vol_5_2,per_5_2 = 0.0,0.0
                days_num = 3 
		per_5_2,vol_5_2,count = get_percent_eq(total_data,days_num,y)
                # print "vol_5_2,per_5_2",vol_5_2,per_5_2,type(total_eq_price),line
		# print "total_eq_price ,total_eq_volume ",total_eq_price ,total_eq_volume
		total_eq_price = list((per_5_2,))+total_eq_price
		total_eq_volume = list((vol_5_2,))+total_eq_volume
		y = y + 1
    ...
    if analyze.get_final_percentage_result() and count>7:
        lock.acquire()
