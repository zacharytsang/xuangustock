...
def get_total_raw_data(line,i):
    ...
    try:
        ...
        while x<=20:
            ...
            vol_3 = 0
            xx = x+30
            vol_1,per_1 = get_percent_eq(total_data,NUM,xx-1)     #NUM,0几天的均线，往后跳几天
            vol_2,per_2 = get_percent_eq(total_data,NUM,xx)     
            vol_3,per_3 = get_percent_eq(total_data,NUM,xx+1)
            if vol_2<vol_1 and vol_3>vol_2:
                final_days = xx
    ...
    if end_price>=highest_pick and my_res > 0.65*len_t:
        lock.acquire()
...
fname ="1lang1lang_impro_40"+fnamet
