...
def get_total_raw_data(line,i):
    ...
    try:
        ...
        while y<=20:
            ...
            tmp_str_below = total_data[lenth-y-1]
            tmp_open = 0.0
            tmp_close = 0.0
            tmp_vol = 0.0
            result_list = tmp_str.split(",")
            result_list_below = tmp_str_below.split(",")
            tmp_open = float(result_list_below[4])
...
fname ="up_more_low_vol"+fnamet+".txt"
